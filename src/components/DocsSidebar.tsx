...
const DOC_ITEMS: DocItem[] = [
  ...
  {
    id: 'iruntha',
    tanglish: 'iruntha / oruvelaerunth condition:\n    ...',
    python: 'if condition:',
    category: 'Keywords',
    desc: 'Executes block if condition is unmai (true). Alias: oruvelaerunth.',
    example: 'mark = 95\niruntha mark >= 90:\n    sollu("A+ Grade")',
  },
  {
    id: 'illatti',
    tanglish: 'illatti / oruvelaillina condition:\n    ...',
    python: 'elif condition:',
    category: 'Keywords',
    desc: 'Alternative condition if preceding iruntha failed. Alias: oruvelaillina.',
    example: 'mark = 75\niruntha mark >= 90:\n    sollu("A Grade")\nillatti mark >= 50:\n    sollu("Pass")',
  },
  {
    id: 'illana',
    tanglish: 'illana / athuvuillina:\n    ...',
    python: 'else:',
    category: 'Keywords',
    desc: 'Fallback default block if all previous conditions failed. Alias: athuvuillina.',
    example: 'mark = 35\niruntha mark >= 50:\n    sollu("Pass")\nillana:\n    sollu("Fail")',
  },
  {
    id: 'varisaiya-kaaga',
  ...
  },
  {
    ...
    example: 'fun double(x):\n    thirupikudu x * 2\n\nsollu(double(8))',
  },
  {
    id: 'kutti_fun',
    tanglish: 'kutti_fun x, y: expr / lineda x, y: expr',
    python: 'lambda x, y: expr',
    category: 'Keywords',
    desc: 'Inline anonymous lambda function. Synonym: lineda.',
  ...
  {
    id: 'raise',
    tanglish: 'raise "message" / raise Exception("msg")',
    python: 'raise Exception("msg")',
    category: 'Keywords',
    desc: 'Raises an error or exception to be caught in muyarchi...thavaru blocks.',
    example: 'age = 15\nmuyarchi:\n    iruntha age < 18:\n        raise "Age must be 18+"\nthavaru err:\n    sollu("Caught:", err)',
  },
  {
    id: 'include',
    tanglish: 'include <module | "file.tpp"> [as alias]',
    python: 'import module / execfile(...)',
    category: 'Keywords',
    desc: 'Imports standard module or executes virtual filesystem script. Can also be called as include("mod").',
    example: 'include ganitham as math\nsollu("Square root of 81:", math.sqrt(81))',
  },
  {
    id: 'from-import',
    tanglish: 'from mod import name [as alias], * / engaerunthu mod eduthuko name',
    python: 'from mod import name, *',
    category: 'Keywords',
    desc: 'Selectively imports symbols or all symbols (*) into local scope.',
    example: 'from ganitham import sqrt, PI\nsollu("sqrt(100):", sqrt(100))\nsollu("PI:", PI)',
  },
  {
    id: 'ulagam',
  ...
  {
    id: 'logical-ops',
    tanglish: 'matrum / apro, alladhu, illai / illa',
    python: 'and, or, not',
    category: 'Keywords',
    desc: 'Logical AND (matrum, apro), OR (alladhu), NOT (illai, illa).',
    example: 'a = 10\nb = poi\niruntha (a > 0) matrum (illai b):\n    sollu("Success")',
  },
  {
    id: 'boolean-literals',
    tanglish: 'unmai, poi, onnumilla / ethumeilla',
    python: 'True, False, None',
    category: 'Keywords',
    desc: 'Boolean truth values and None equivalent (onnumilla, ethumeilla).',
